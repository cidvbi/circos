        ...
        <form id="image_data_form" action="/circos/home" method="POST" enctype="multipart/form-data">
            <div id="left_side">
                ...
                <%
                   ...
                   fields.addAll(Arrays.asList(new String[] {"CDS Forward", "CDS Reverse", "RNA Forward", "RNA Reverse", "Misc Forward", "Misc Reverse"}));
            ...
            <div id="right_side">
                ...
                <br><br>
                <div name="file_list" id="file_list">
                </div>
...
...</pre>
                <h3>
                    Three column files should be displayed as tiles. Four column files can be displayed as line plots, histograms, or heatmaps.
                </h3>
            </div>
        </form>
    </div>
